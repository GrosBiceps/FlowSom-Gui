# -*- coding: utf-8 -*-
"""
mrd_adapter.py â€” Adaptateur MRDResult â†’ structures UI-friendly.
...
def adapt_mrd_result(result: Any, method_used: str = "all") -> Dict[str, Any]:
    """
    Extrait les donnÃ©es MRD d'un PipelineResult pour l'UI.

    Args:
        result: PipelineResult (post-pipeline).
        method_used: mÃ©thode choisie par l'utilisateur ("all", "jf", "flo", "eln").

    Returns:
        dict avec les clÃ©s :
          - patient_info: dict (nom, date, fichier)
          - gauges: list de dict par mÃ©thode affichÃ©e
          - nodes: list de dict (tous les nÅ“uds MRD positifs)
          - method_used: str
    """
    ...
    # â”€â”€ Infos patient â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    patient_info = {
    ...
    # â”€â”€ Gauges par mÃ©thode â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    gauges: List[Dict[str, Any]] = []

    # ELN n'est jamais affichÃ© dans l'onglet Accueil (trop de faux positifs dans
    # l'usage courant). ELN reste calculÃ© par le pipeline et exportÃ© dans les
    # rapports, mais la gauge UI est rÃ©servÃ©e Ã  JF et Flo.
    ...
    # â”€â”€ NÅ“uds MRD positifs (pour le tableau) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def adapt_all_nodes(mrd: Any) -> List[Dict[str, Any]]:
    """
    Retourne la liste de TOUS les nÅ“uds SOM patients, y compris ceux non
    ...
    contrairement Ã  adapt_mrd_result() qui reÃ§oit un PipelineResult.

    Chaque dict contient les mÃªmes clÃ©s que adapt_mrd_result() avec les flags
    is_mrd_jf / is_mrd_flo / is_mrd_eln Ã  False pour les nÅ“uds non sÃ©lectionnÃ©s.
    """
    if mrd is None:
        return []
